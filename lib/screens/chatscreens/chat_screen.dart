...
import 'package:tedmed2/constants/strings.dart';
import 'package:tedmed2/enum/view_state.dart';
import 'package:tedmed2/models/message.dart';
    ...
    return CustomAppBar(
      ...
      actions: <Widget>[
        IconButton(
          ...
          onPressed: () {
            Navigator.pushNamed(context, "/joinvideo_screen");
          },
        ),
        IconButton(
          icon: Icon(
